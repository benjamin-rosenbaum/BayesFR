...
(An alternative parameterization $\frac{f_\max N}{N_\text{half}+N}$ using maximum feeding rate and handling time is presented in the priors tutorial.)
...
#| echo: false
#| output: false
# fit.1 = readRDS(file=here::here("fit1.rds"))
