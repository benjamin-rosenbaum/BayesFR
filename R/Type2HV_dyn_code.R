...
#' solution of the \bold{Hassell-Varley} model
#' \deqn{\frac{dN}{dt}=-\frac{aN}{P^c+ahN}P}{dN/dt=-aNP/(P^c+ahN)}
...
#' \verb{~ Type2HV_dyn(N, P, Time, a, h, c)}\cr\cr
...
Type2HV_dyn_code = "
// prediction
real Type2HV_dyn(real N, real P, real Time, real a, real h, real c){
  real a_new = a/(P^c);
